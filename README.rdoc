...
Application Link: https://class-ncsu.herokuapp.com/
...
#7. Email for notification [BONUS]:
...
- Enrollment active change request email works on dev environments using ruby mail gem, on production the user will get a private message instead.
